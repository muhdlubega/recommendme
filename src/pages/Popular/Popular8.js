...
function Popular8(){
    ...
    const getPop = () => {
        APIKey.getPopular8().then(output => {setPopularArr(output?.data?.results)})
    }
    ...
    return(
        <div>
            <Header></Header>
            <div className="topic">Popular Shows<span className="pagecount">Page 8 of 10</span></div>
