...
function Popular10(){
    ...
    const getPop = () => {
        APIKey.getPopular10().then(output => {setPopularArr(output?.data?.results)})
    }
    ...
    return(
        <div>
            <Header></Header>
            <div className="topic">Popular Shows<span className="pagecount">Page 10 of 10</span></div>
