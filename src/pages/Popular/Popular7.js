...
function Popular7(){
    ...
    const getPop = () => {
        APIKey.getPopular7().then(output => {setPopularArr(output?.data?.results)})
    }
    ...
    return(
        <div>
            <Header></Header>
            <div className="topic">Popular Shows<span className="pagecount">Page 7 of 10</span></div>
