...
function TopRated10(){
    ...
    const getTop = () => {
        APIKey.getTopRated10().then(output => {setTopRatedArr(output?.data?.results)})
    }
    ...
    return(
        <div>
            <Header></Header>
            <div className="topic">Top Rated Shows<span className="pagecount">Page 10 of 10</span></div>
