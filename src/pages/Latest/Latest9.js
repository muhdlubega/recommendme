...
function Latest9(){
    ...
    const getLat = () => {
        APIKey.getLatest9().then(output => {setLatestArr(output?.data?.results)})
    }
    ...
    return(
        <div>
            <Header></Header>
            <div className="topic">Latest Shows<span className="pagecount">Page 9 of 10</span></div>
