...
function Latest8(){
    ...
    const getLat = () => {
        APIKey.getLatest8().then(output => {setLatestArr(output?.data?.results)})
    }
    ...
    return(
        <div>
            <Header></Header>
            <div className="topic">Latest Shows<span className="pagecount">Page 8 of 10</span></div>
