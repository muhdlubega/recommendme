...
function Latest6(){
    ...
    const getLat = () => {
        APIKey.getLatest6().then(output => {setLatestArr(output?.data?.results)})
    }
    ...
    return(
        <div>
            <Header></Header>
            <div className="topic">Latest Shows<span className="pagecount">Page 6 of 10</span></div>
