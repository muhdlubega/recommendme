...
function Latest7(){
    ...
    const getLat = () => {
        APIKey.getLatest7().then(output => {setLatestArr(output?.data?.results)})
    }
    ...
    return(
        <div>
            <Header></Header>
            <div className="topic">Latest Shows<span className="pagecount">Page 7 of 10</span></div>
